...
class Dataset(base.Dataset):
    ...
    def __init__(self,opt,split="train",subset=None):
        ...
        #barf
        # self.root = "data/custom3"
        # if os.path.exists(os.path.join(self.root, 'transforms.json')):
